package me.andrea.motion_tracker.opengl_animation.Animation.animation;
...
public class Animator {
	 ...
	 */
	public void doAnimation(Animation animation, AnimatedModel model) {
	...
	private void increaseAnimationTime() {
		...
		float deltaTime = (currentTime - lastFrameTime) / 1_000_000_000.0f; // Convert from nanoseconds to seconds
